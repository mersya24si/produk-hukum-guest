    ...
    <section id="form" class="pt-100 pb-100 bg-light">
        <div class="container">
            <div class="section-title text-center mb-5">
                <h2 class="fw-bold">Form Edit Data Warga</h2>
                <p class="text-muted">Ubah data berikut untuk memperbarui informasi warga di sistem Bina Desa.</p>
            </div>
                    ...
                    <div class="card shadow border-0 p-4">
                        <form action="{{ route('warga.update', $dataWarga->warga_id) }}" method="POST">
                            ...
                            <div class="text-center">
                                ...
                                <a href="{{ route('warga.index') }}" class="main-btn btn-outline-secondary ms-2">Kembali</a>
                            </div>
