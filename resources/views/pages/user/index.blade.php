        ...
        <div class="table-responsive">
                    ...
                    @foreach ($dataUser as $item)
                        <div class="col-md-4 col-sm-6">
                            <div class="card shadow-sm border-0 rounded-4 h-100">
                                <div class="card-body">
                                    <h5 class="card-title fw-bold text-primary mb-3">{{ $item->name }}</h5>
                                    ...
                                    <div class="mt-3">
                                        <p class="card-text text-muted mb-0 small">
                                            ...
                                            <code class="d-block bg-light p-1 rounded">{{ Str::limit($item->password, 30, '...') }}</code>
                                        </p>
                                    </div>
                                </div>
            ...
            @else
                ...
                <div class="alert alert-info text-center mt-4">
                    <p class="mb-0">Tidak ada data user yang ditemukan sesuai kriteria pencarian.</p>
                </div>
            @endif

            <div class="text-end mt-5">
                <a href="{{ route('user.create') }}" class="btn btn-success shadow-lg rounded-pill px-4 py-2">
