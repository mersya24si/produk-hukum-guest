...
@section('content')
    ...
    <section id="form-edit-riwayat" class="pt-100 pb-100 bg-light">
        <div class="container">
            ...
            <div class="section-title text-center mb-5 border-bottom pb-3">
                <h2 class="fw-bold text-logo-accent">Form Edit Riwayat Perubahan</h2>
                <p class="text-muted">Perbarui log perubahan untuk dokumen hukum.</p>
            </div>
                            ...
                            <div class="row g-4">
                                ...
                                <div class="col-12">
                                    ...
                                    <select name="dokumen_id" id="dokumen_id" class="form-select rounded-pill @error('dokumen_id') is-invalid @enderror" required>
                                        ...
                                        @foreach ($dokumenList as $dokumen)
                                            <option value="{{ $dokumen->dokumen_id }}" {{ old('dokumen_id', $riwayat->dokumen_id) == $dokumen->dokumen_id ? 'selected' : '' }}>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="tanggal" id="tanggal" class="form-control rounded-pill @error('tanggal') is-invalid @enderror"
                                        value="{{ old('tanggal', $riwayat->tanggal->format('Y-m-d')) }}" required>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="text" name="versi" id="versi" class="form-control rounded-pill @error('versi') is-invalid @enderror"
                                        placeholder="Contoh: 2.1" value="{{ old('versi', $riwayat->versi) }}">
                                ...
                                <div class="col-12">
                                    ...
                                    <textarea name="uraian_perubahan" id="uraian_perubahan" class="form-control rounded-4 @error('uraian_perubahan') is-invalid @enderror" rows="5"
                                        placeholder="Jelaskan perubahan spesifik yang terjadi pada dokumen ini." required>{{ old('uraian_perubahan', $riwayat->uraian_perubahan) }}</textarea>
                                ...
                                <div class="col-12 text-center mt-5">
                                    ...
                                    <a href="{{ route('riwayat.index') }}" class="btn btn-outline-secondary rounded-pill px-4">
                                        Batal
                                    </a>
                                </div>
                            </div>
