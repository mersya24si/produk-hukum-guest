    ...
    <section id="form" class="pt-100 pb-100 bg-light">
        <div class="container">
            <div class="section-title text-center mb-5">
                <h2 class="fw-bold">Form Input Data Jenis Dokumen</h2>
                <p class="text-muted">Isi data Jenis Dokumen ke sistem Bina Desa.</p>
            </div>
                        ...
                        <form action="{{ route('jenisdokumen.store') }}" method="POST">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="nama_jenis" id="nama_jenis" class="form-control"
                                    placeholder="Masukkan nama" required {{ old('nama_jenis') }}>
                            </div>
                            <div class="mb-3">
