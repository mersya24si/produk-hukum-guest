        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="mb-3">
                        <h1 class="h3 d-inline align-middle">Input Kategori</h1>
                        <a href="{{ route('kategori.index') }}" class="btn btn-secondary btn-sm ms-2">Lihat Kategori</a>
                    </div>
                            ...
                            <div class="card">
                                ...
                                <form action="{{ route('kategori.store') }}" method="POST">
                                    ...
                                    <div class="card-body">
                                       ...
                                       <textarea name="deskripsi" cols="30" rows="10" value="{{ old('nama') }}"></textarea>
                                    </div>
