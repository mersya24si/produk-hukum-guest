        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="mb-3">
                        <h1 class="h3 d-inline align-middle">Edit Data Warga</h1>
                                ...
                                <form action="{{ route('warga.update', $dataWarga->warga_id) }}" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="text" class="form-control" 
                                            name="no_ktp" value="{{ old('no_ktp', $dataWarga->no_ktp) }}" readonly>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="text" class="form-control"
                                            name="pekerjaan" value="{{ old('pekerjaan', $dataWarga->pekerjaan) }}">
                                    </div>
                                    ...
                                    <div class="card-body">
                                        ...
                                        <input type="email" class="form-control" 
                                            name="email" value="{{ old('email', $dataWarga->email) }}">
                                    </div>
